            ...
            <div className="container hero-container">
                <div className="hero-content fade-in visible">
                    ...
                    <div className="hero-contacts">
                        ...
                        <a href={personal.github} target="_blank" rel="noopener noreferrer" className="contact-badge" id="contactGithub">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <a href={personal.linkedin} target="_blank" rel="noopener noreferrer" className="contact-badge" id="contactLinkedin">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
